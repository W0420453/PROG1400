...
public class Deck {
     ...
     * @param makeDeck , True or False to determine if the deck should be filled with cards or not
     */
     ...
     * @param card an Card Object to be added to the deck
     */
    ...
    {
        //Variable to contain the string to be build
        String output = "";

        //for every card inside the deck object.
        for(Card card: deck)
        {
            //Add the card and a newline to the output string
            output += card;
            output += "\n";
        }
        return output;
    ...
    public void shuffle(){
        ...
        // Loops until the deck has been reduced to 0, each loop removing 1 card
        while(deck.size()>0)
        {
     ...
     * @param cards An ArrayList of card objects, which for this program will be another deck of cards.
     */
    ...
    /**
     * Returns the Contents of this deck
     * @return The contents of this deck object
     */
