...
public class Main {
    public static void main(String[] args)
    {
        ...
        */
        ...
        {
            grades.add((int)(Math.random() * 49 + 51));
        }
        ...
        Employee employee1 = new Employee("Nathan", "The Moon", 1002, 50000, 22, "02/10/2000");

        System.out.println("\nBefore the Salary Raise");
        employee1.printEmployeeInformation();
        employee1.printStartDate();
        ...
        System.out.println(employee1.stringToDate("02/10/2000"));

        Customer cust1 = new Customer("Nathan", "L'Abbe");
